...
<head>
        ...
        <title>Aplikasi pengiriman pesan Email dalam gambar menggunakan kombinasi Algoritma Advanced Encryption standar 128 bit dan LSB.</title>
        ...
        <div class="wrapper-page animated fadeInDown">
            ...
            <span class="block-title-2"> 
                ...
                <div class="panel-heading"> 
                   <h3 class="text-center m-t-10"><strong>Lupa Password</strong> <p>&nbsp;</p><img src="../../assets/back-end/img/logo.png" width="150px" height="150px"> </h3>
                </div> 
                <?php
                    error_reporting(0);
                    $nama      = $_GET['nama'];
                    ...
                    $email     = $_GET['email'];
                ?>
                <form class="form-horizontal m-t-40" action="reset.php" method="POST">
                    ...
                    <div class="form-group text-right">
                        <div class="col-xs-12">
                            <button class="btn btn-purple w-md" type="submit">Konfirmasi</button> 
                        </div>
                    </div>
