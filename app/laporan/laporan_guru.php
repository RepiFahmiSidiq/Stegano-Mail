...
<div class="page-title"> 
    <h3 class="title"><i class="fa fa-user"></i> <?php echo strtoupper('LAPORAN DATA GURU') ?></h3> 
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <button type="button" class="btn btn-primary m-b-5"><i class="fa fa-hand-o-down"></i> Data Kas</button>
                </a>  
            </div>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <form class="form-horizontal" name="form1" method="POST" enctype="multipart/form-data" action="" >
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-offset-2 col-sm-9">
                              ...
                              <a href="cetak/excel_guru.php?id_guru=<?php echo $id_guru?>" target="_blank">
                    ...
                    <div class="box-body table-responsive"> 
                        <table id="laporan_guru" class="table table-striped table-bordered" style="font-size: 11px">
                              <thead>
                                  <tr>
                                    <th width="5%">No</th> 
                                    <th width="7%">NIP</th> 
