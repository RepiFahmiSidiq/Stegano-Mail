...
<div class="wraper container-fluid">
    <div class="page-title"> 
        <h3 class="title"><i class="fa fa-home"></i> <?php echo strtoupper('Kotak Keluar') ?></h3> 
    </div>
    <div class="row">
        <div class="col-lg-12">
                                ...
                                <tbody>
                                  <?php 
                                    if ($level=='ADMIN'){ 
                                      ...
                                      $cari = " AND tbl_email.id_user=$id_user ";
                                    }
                                    $result = $mysqli->query("SELECT tbl_email.*,
                                              tbl_user.nama
                                              FROM tbl_email,tbl_user 
                                              WHERE tbl_email.id_user=tbl_user.id_user ".$cari);
                                        $no = 1;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                              if ($level=='USER'){
                                            ?>
                                            <a href="?mod=decrypt&pg=form_input_decryptemail&id_email=<?php echo $id_email;?>"><button class="btn btn-icon btn-success btn-sm"> <i class="fa fa-eye"></i> Kontak Keluar</button></a>
